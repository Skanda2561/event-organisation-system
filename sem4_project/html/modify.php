  ...
  <body style="background-image:url(../images/cbg.png);background-repeat:no-repeat;background-attachment:fixed;background-size:cover;">
    ...
    <div class="btns">
      ...
      <form class="" action="modify.php" method="post" >
        ...
        <input type="submit" value="Cancel event" onclick="return confirm('Are you sure to cancel the event??')"id="regbtn" style="background: var(--shade2);opacity: 0.8;color: var(--text);border-radius: 20px;text-align: center;border-style: none;margin-left: 15px;margin-bottom: 20px;height: 40px; float: right;" >
      </form>
    </div>
  ...
  <div id="demo" class="collapse">
		<div class="" id="create">
			<form class="" method="post" enctype="multipart/form-data">
				...
				<input type="hidden" name="ueid" value="<?php echo $ueid;?>">
				<input type="submit" name="submitforu"onclick="return confirm('Are you sure to change the information?')" value="Update" ><br>
